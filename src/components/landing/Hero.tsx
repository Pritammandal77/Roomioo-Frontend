...
function Hero() {
  ...
  return (
    <section className="w-full min-h-screen flex items-center justify-center bg-green-50 px-6 pt-20 md:pt-20 xl:pt-17 md:px-10 xl:px-0">
      <div className="max-w-7xl w-full grid xl:grid-cols-2 gap-10 items-center">
        {/* LEFT CONTENT */}
        <div className="space-y-6">
          <motion.h1
            ...
            className="text-4xl md:text-6xl font-bold md:text-center xl:text-left text-gray-900 leading-tight"
          >
          ...
          <motion.p
            ...
            className="text-gray-600 text-lg md:text-center xl:text-left"
          >
          ...
          >
            {user ? (
              <div className="flex items-center justify-center xl:items-start xl:justify-start gap-4 flex-wrap">
